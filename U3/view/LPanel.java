...
public class LPanel extends JPanel {
    ...
    private void setUp() {
        ...
        btnDelete.setSize(width / 5, 30);
        btnDelete.setLocation((width / 5)*2, height - 75);
        btnDelete.addActionListener(l -> {
            mainFrame.buttonPressed(ButtonType.Delete);
        });
        this.add(btnDelete);
    ...
    protected JButton getBtnDelete() { return btnDelete; }
