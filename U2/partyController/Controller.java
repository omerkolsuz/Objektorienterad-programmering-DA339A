...
public class Controller {
        ...
        switch (button) {
            case Add:
                ...
                */
                 ...
                 */
                register.addGuest(view.getFirstNameText(), view.getLastNameText(), view.getStreetText(),
                        view.getZipCodeText(), view.getCityText(), country);
                break;
            ...
            case Change:
                ...
                if (validateIndex(index)) { //validateIndex is a private method in this class
                    ...
                    if (guestToChange != null){
                        ...
                        // skapa ett
                     //   Object it = view.getCountriesItem();
                      //  Countries coun = (Countries) it;
                        //Address adres = view.getStreetText(guestToChange);
                        //view.setStreetText(guestToChange.getAdres().getStreet()), view.getCityText(), view.getZipCodeText(), coun;
                        guestToChange.setFirstName(view.getFirstNameText());
                        guestToChange.setLastName(view.getLastNameText());
                        guestToChange.getAdres().setStreet(view.getStreetText());
                        guestToChange.getAdres().setCity(view.getCityText());
                        guestToChange.getAdres().setZipCode(view.getZipCodeText());
                        guestToChange.getAdres().setCountries((Countries) view.getCountriesItem());
                    }
                    else {
            ...
            case Delete:
                ...
                if (validateIndex(index)) {
                    ...
                    */
                    register.moveElementsToLeft(index);
                }
                break;
        }
    ...
    private void updateView(int index) {
        ...
        if(validateIndex(index)) {
            Guest guest = register.getGuestAt(index); //Remove later when line below is used
            ...
            if (guest == null) {
                ...
                view.setStreetText(guest.getAdres().getStreet());
                view.setZipCodeText(guest.getAdres().getZipCode());
                view.setCityText(guest.getAdres().getCity());
                view.setCountriesItem(guest.getAdres().getCountry());
            }
        }
    }
