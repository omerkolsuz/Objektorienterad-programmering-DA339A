      ...
      if (guestList[i][0] != "" ) {
       ...
       if(omfinnsgast){
          System.out.println("Ange första numret på gästen du vill byta plats på!");
            System.out.println("------------------------------------");
              index = input.nextInt();
                if(index < guestList.length && guestList[index][0] == ""){
                  ...
                  if(index1 < guestList.length && guestList[index1][0] != "" ){
                    System.out.println("Du försöker byta plats på en gäst vilken är inte finns i listan!");
            }         else if(index >= guestList.length || index1 >= guestList.length) {
                        System.out.println(" du försöker byta plats på en gäst vilken är inte i listan! ");
                      }
                  else if (guestList[index1][0] != "" || guestList[index][0] == ""){
                      String[] temp1;
                        temp1 = guestList[index];
                          String[] temp2;
                           temp2 = guestList[index1];
                            guestList[index] = temp2;
                             guestList[index1] = temp1;
